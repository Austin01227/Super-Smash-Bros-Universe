...
if (run)
	...
	switch(_phase)
		...
		case PHASE.start:
			...
			parry_stun_time=60;
			set_speed(clamp(hsp,-2,2),clamp(vsp,0,0),false,false);
			attack_frame=8;
			return;
			}
		...
		case 0:
			...
			if (attack_frame==0)
				...
				attack_phase++;
				attack_frame=5;
				var _hitbox = create_melee(0,-7,1,0.3,5,0.1,0.1,8,70,2,HITBOX_SHAPE.rotation,0);
		...
		case 1:
			...
			if (attack_frame==0)
				...
				attack_phase++;
				attack_frame=10;
				var _hitbox = create_melee(0,0,0.6,0.6,5,0.1,0.1,15,270,2,HITBOX_SHAPE.circle,0);
