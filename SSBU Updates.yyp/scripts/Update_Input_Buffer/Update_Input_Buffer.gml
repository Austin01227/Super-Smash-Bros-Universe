...
if (_keyboard)
	...
	if keyboard_check_pressed(ord("vk_up")) _buffer[| _cc[2]] = 0;
	if keyboard_check(ord("vk_up")) _buffer[| _cc[2] + INPUT.length] = 0;		   
	if keyboard_check_pressed(vk_up) _buffer[| _cc[3]] = 0;
	if keyboard_check(vk_up) _buffer[| _cc[3] + INPUT.length] = 0;		   
	//Back buttons									   
	if keyboard_check_pressed(ord("D")) _buffer[| _cc[4]] = 0;
	if keyboard_check(ord("D")) _buffer[| _cc[4] + INPUT.length] = 0;
	if keyboard_check_pressed(ord("F")) _buffer[| _cc[5]] = 0;
	if keyboard_check(ord("F")) _buffer[| _cc[5] + INPUT.length] = 0;   
	if keyboard_check_pressed(ord("Z")) _buffer[| _cc[6]] = 0;
	if keyboard_check(ord("Z")) _buffer[| _cc[6] + INPUT.length] = 0;    
	if keyboard_check_pressed(ord("X")) _buffer[| _cc[7]] = 0;
	if keyboard_check(ord("X")) _buffer[| _cc[7] + INPUT.length] = 0;   
	//Pausing										    
