	...
	switch(_phase)
		...
		case 1:
			...
			if (attack_frame==8)
				{
				anim_frame=5;
				create_melee(21,12,1,1,4,8,0.6,4,50,2,HITBOX_SHAPE.circle,0,FLIPPER.from_player_center_horizontal);
				}
			if (attack_frame==6)
				{
				anim_frame=6;
				create_melee(4,29,1,1,4,5,0.6,4,50,3,HITBOX_SHAPE.circle,0,FLIPPER.from_player_center_horizontal);
				}
			if (attack_frame==3)
				{
				anim_frame=7;
				create_melee(-20,15,1,1,4,5,0.6,4,50,3,HITBOX_SHAPE.circle,0,FLIPPER.from_player_center_horizontal);
				}
			if (attack_frame==0)
				{
				anim_frame=8;
